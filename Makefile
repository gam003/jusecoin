#############################################################################
# Makefile for building: jusecoin-qt
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  Jusecoin-qt.pro
# Template: app
# Command: /data/downloads/mxe/usr/bin/i686-w64-mingw32.static-qmake-qt5 BOOST_LIB_SUFFIX=-mt BOOST_THREAD_LIB_SUFFIX=_win32-mt BOOST_INCLUDE_PATH=/data/downloads/mxe/usr/i686-w64-mingw32.static/include/boost BOOST_LIB_PATH=/data/downloads/mxe/usr/i686-w64-mingw32.static/lib OPENSSL_INCLUDE_PATH=/data/downloads/mxe/usr/i686-w64-mingw32.static/include/openssl OPENSSL_LIB_PATH=/data/downloads/mxe/usr/i686-w64-mingw32.static/lib BDB_INCLUDE_PATH=/data/downloads/mxe/usr/i686-w64-mingw32.static/include BDB_LIB_PATH=/data/downloads/mxe/usr/i686-w64-mingw32.static/lib MINIUPNPC_INCLUDE_PATH=/data/downloads/mxe/usr/i686-w64-mingw32.static/include MINIUPNPC_LIB_PATH=/data/downloads/mxe/usr/i686-w64-mingw32.static/lib QMAKE_LRELEASE=/data/downloads/mxe/usr/i686-w64-mingw32.static/qt5/bin/lrelease -o Makefile Jusecoin-qt.pro
#############################################################################
...
QMAKE         = /data/downloads/mxe/usr/bin/i686-w64-mingw32.static-qmake-qt5
DEL_FILE      = rm -f
...
Makefile: Jusecoin-qt.pro ../../mxe/usr/i686-w64-mingw32.static/qt5/mkspecs/win32-g++/qmake.conf ../../mxe/usr/i686-w64-mingw32.static/qt5/mkspecs/features/spec_pre.prf \
...
clean: release-clean debug-clean  FORCE
	-$(DEL_FILE) /data/downloads/new1/jusecoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) /data/downloads/new1/jusecoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) /data/downloads/new1/jusecoin/jusecoin-qt_plugin_import.cpp .qmake.stash

/data/downloads/new1/jusecoin/src/leveldb/libleveldb.a: FORCE
	cd /data/downloads/new1/jusecoin/src/leveldb && CC=i686-w64-mingw32.static-gcc CXX=i686-w64-mingw32.static-g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && i686-w64-mingw32.static-ranlib /data/downloads/new1/jusecoin/src/leveldb/libleveldb.a && i686-w64-mingw32.static-ranlib /data/downloads/new1/jusecoin/src/leveldb/libmemenv.a
